                        ...
                        std::vector<Choice> choices = {
                            {"Pumunta", [&]() {
                                std::vector<DialogueEntry> choice1Dialogue = {
                                    ...
                                    {"Wala ako makitang billboards o advertisement. May artista kaya sila o may istasyon\nsila dito para panuorin yung mga pinapalabas satin. May wifi o signal kaya\ndito para makaka contact sa labas.", "???"},
                                    ...
                                    {"'Bago ka lang ba?'", "???"},  // CHARACTER NAME MYSTERIOUS ???
                                    ...
                                    {"Ngayong buwan ka lang ba binago?", "???"},
                        ...
                        std::vector<Choice> choices = {
                            {"Makipagkamay", [&]() {
                                std::vector<DialogueEntry> choice1Dialogue = {
                                    ...
                                    {"'Mukhang ang bata mo pa para matali dito sa mundong toh.'", "???"},  //Stranger message
                                    ...
                                    {"Sadyang di na ako tatanda simula nang binago ang anyo ko.", "???"}, //Stranger
                                    {"Ilang taon ho kayo nun?", "???"},
                                    {"23, Ilang taon ka na ba (Iha, Iho)?", "???"}, //Stranger
                                    {"18 po.", "???"},
                                    ...
                                    {"Sya ? Si Maca.Apo ni Aleng Lina.Bumibisita rin katulad mo.Mga– Ilang taon ka na ba ? ’", "???"},
                                    {"19 po!", "???"},
                                    {"Kasing age mo lang. Mayayaman yang mga yan. Rinig ko nasa bandang manila yan\nnag-aaral. Di ko maalala kung anong school.", "???"},
                                    {"Ganun ba", "???"},
                                    {"Mhmm-mm", "???"},
                                    ...
                                    {"'Pagpasensyahan nyo na si Lola,' patawa nyang sabi.", "???"},
                                    {"Ganyan talaga sya, bossy.", "???"},
                                    {"'Mga kaibigan ko nga pala.' Habang tinuturo at pinapakilala nya ang mga kaibigan.", "???"},
                                    ...
                                    {"Kanino kang Apo?", "???"},
                                    {"Kay Lola Irina.", "???"},
                                    {"Ah.. ikaw yung apo nya na galing maynila.", "???"},
                                    ...
                                    {"'Oo, Maca nga pala.' Sabi niya sabay nilahad nya yung kamay niya.", "???"},
                                    ...
                                    {"Ako si Juan at eto ang anak ko at inaanak ko.", "???"}, //juan
                                    ...
                                    {"'May Kinain ka na ba?' Mabilis nyang tanong.", "???"},
                                    {"Wala pa.", "???"},
                                    {"May nagbigay na ba sayo ng gift o nagkumbinsi na sumama ka sa kanila?", "???"},
                                    {"Wala at yung tito mo pa lang sinundan ko.", "???"},
                                    {"Napabuntong sya ng hininga sa sinabi ko pero napahaplos sya ng noo nya.", "???"},
                                    {"Di ko alam kung matatakot ako para sa iyo o magpapasalamat na yung tito ko pa lang.", "???"},
                                    {"Nalito ako sa sinabi niya. Ano ba kadalasan ang nangyayari? Ano pa ba ang pedeng\nmangyari na masama?", "???"},
                                    {"May mga nagba-bala ba sayo nung nakarating ka dito na umalis ka agad?", "???"},
                                    {"Uh..", "???"},
                                    ...
                                    {"Hindi lang ikaw ang tao dito, may pistang bukas, parang valentines day sa mundo nyo.", "???"},
                                    ...
                                    {"Nabanggit rin ba nila kung bakit nila ginagawa ito?", "???"},
                                    {"Dahil mahal ka nila?”", "???"},
