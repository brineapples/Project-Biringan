...
// Constructor - sets up the screen content
    ...
    : window(win), titleFont(titleFnt), bodyFont(bodyFnt)
{
    ...
    aboutText.setCharacterSize(24);   // Medium size
    aboutText.setFillColor(sf::Color::White);
    aboutText.setPosition(50, 150);   // Position on the screen

    // Use body font for back button
    backButton.setFont(bodyFont);
    backButton.setString("Back");
    backButton.setCharacterSize(30);  // Slightly larger text for a button
    backButton.setFillColor(sf::Color::White);
    backButton.setPosition(50, 500);  // Placed near the bottom
...
void AboutScreen::handleMouseHover(const sf::Vector2f& mousePos) {
    ...
    backButton.setFillColor(backButton.getGlobalBounds().contains(mousePos) ? sf::Color::Red : sf::Color::White);
}
